...
successfully establish "consistent API look and feel" quality. The API SIG repurposed these guidelines from Zalando's API guidelines and owns this document.
