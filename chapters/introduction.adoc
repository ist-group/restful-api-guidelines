...
engineering teams own, deploy and operate these microservices. Our APIs most purely express what our systems do, and are therefore highly valuable business assets.
...
successfully establish "consistent API look and feel" quality. The API SIG repurpused these guidelines from Zalando's API guidelines and owns this document.
