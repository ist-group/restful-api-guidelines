...
| `string` | `email` | {RFC-5322}[RFC 5322] | `"example@ist.com"`
| `string` | `idn-email` | {RFC-6531}[RFC 6531] | `"hello@växjö.example"`
| `string` | `hostname` | {RFC-1034}[RFC 1034] | `"www.ist.com"`
| `string` | `idn-hostname` | {RFC-5890}[RFC 5890] | `"växjö.example"`
| `string` | `ipv4` | {RFC-2673}[RFC 2673] | `"104.75.173.179"`
| `string` | `ipv6` | {RFC-4291}[RFC 4291] | `"2600:1401:2::8a"`
| `string` | `uri` | {RFC-3986}[RFC 3986] | `"https://www.ist.com/"`
| `string` | `uri-reference` | {RFC-3986}[RFC 3986] | `"/grades/"`
| `string` | `uri-template` | {RFC-6570}[RFC 6570] | `"/grades/\{id\}"`
| `string` | `iri` | {RFC-3987}[RFC 3987] | `"https://växjö.example/"`
