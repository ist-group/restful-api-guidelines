...
[Rule #157](https://ist-group.github.io/rest-guidelines/#157)`
...
[#227]
== {MUST} document cacheable `GET` and `HEAD` endpoints
...
* Document all <<cacheable>> {GET} and {HEAD} endpoints by declaring
